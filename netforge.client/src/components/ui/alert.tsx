  ...
  'relative grid w-full grid-cols-[0_1fr] items-start gap-y-0.5 rounded-lg border px-4 py-3 text-sm has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] has-[>svg]:gap-x-3 [&>svg]:size-4 [&>svg]:translate-y-0.5',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-destructive/30 text-destructive bg-destructive/5 [&>svg]:text-current *:data-[slot=alert-description]:text-destructive/90',
        success:
          'border-success/30 text-success bg-success/5 [&>svg]:text-current *:data-[slot=alert-description]:text-success/90',
      },
    },
